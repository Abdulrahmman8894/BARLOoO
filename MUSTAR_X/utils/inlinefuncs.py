...
from BARLOoO import pbot as app 
from BARLOoO import arq
from BARLOoO.services.keyboard import Ikb
from BARLOoO.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from BARLOoO.services.tasks import _get_tasks_text, all_tasks, rm_task
from BARLOoO.services.types import InlineQueryResultCachedDocument
from BARLOoO.modules.info import get_chat_info, get_user_info
from BARLOoO.modules.music import download_youtube_audio
from BARLOoO.utils.functions import test_speedtest
from BARLOoO.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/barlo0o_bot"),
        InlineKeyboardButton(
...
async def music_inline_func(answers, query):
    ...
    group_invite = "https://t.me/+Y-4lOr6g4044YjRk"
    try:
        messages = [
            m
