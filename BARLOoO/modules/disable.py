...
from BARLOoO.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from BARLOoO.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from BARLOoO.modules.sql import disable_sql as sql
