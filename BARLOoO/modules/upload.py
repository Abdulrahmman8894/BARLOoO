...
from BARLOoO import telethn as bot
from BARLOoO.modules.urluploader import download_file
from BARLOoO.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *barlo0o_bot*",
            )
        except Exception as e:
            traceback.print_exc()
