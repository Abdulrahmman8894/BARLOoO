...
from BARLOoO.__main__ import STATS, TOKEN, USER_INFO
from BARLOoO.modules.sql import SESSION
import BARLOoO.modules.sql.userinfo_sql as sql
from BARLOoO.modules.disable import DisableAbleCommandHandler
from BARLOoO.modules.sql.global_bans_sql import is_user_gbanned
from BARLOoO.modules.sql.afk_sql import is_afk, set_afk
from BARLOoO.modules.sql.users_sql import get_user_num_chats
from BARLOoO.modules.helper_funcs.chat_status import sudo_plus
from BARLOoO.modules.helper_funcs.extraction import extract_user
from BARLOoO import telethn
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/bar_lo0o0o0o0o/123"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/bar_lo0o0o0o0o/123")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current BARLO Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>╘═━「 Powered By BARLOoO 」</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/bar_lo0o0o0o0o/123)
"""
