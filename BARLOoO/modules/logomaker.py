...
from BARLOoO import telethn as tbot, ubot2
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = glob.glob("./BARLOoO/resources/fonts/*")
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="Logo by [Caty New](https://t.me/barlo0o_bot)",
    ...
    if os.path.exists(font_):
        if not font_.startswith("./BARLOoO/resources/fonts"):
            os.remove(font_)
